...
public class MaddysManyMiniatureModificationsEmiAnvilRecipe implements EmiRecipe {
    private final EmiStack tool;
    private final EmiIngredient resource;
    private final Identifier id;
    private final int uniq = MaddysManyMiniatureModifications.MaddyRandom.nextInt();

    public MaddysManyMiniatureModificationsEmiAnvilRecipe(EmiStack tool, EmiIngredient resource, Identifier id) {
        this.tool = tool;
